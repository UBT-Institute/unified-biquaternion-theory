...
The parent track is `psi_branch_selection.en.md`. G3-DYN remains OPEN. Gap C1 remains conditional on T2_GAUGE as recorded in `canonical/chirality/gap_c1_closure.tex`; this calculation does not independently validate that bridge. The complete composite action, physical fluctuation measure, kinetic normalization and gravitational coefficient remain unresolved. The original biquaternionic field and covariant tetrad are unchanged; no canonical gap or author attestation is upgraded.
