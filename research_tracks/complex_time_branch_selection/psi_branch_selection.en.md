...
| G3-DYN | Dynamic use of \(\Gamma_*D_\psi\), its normalization, left/right action and action origin | OPEN (NARROWED: free-Hamiltonian sub-route is NO-GO; see `psi_fock_quantization_chirality_link.en.md`) |
