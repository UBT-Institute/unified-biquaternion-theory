...
| G3-DYN | Dynamické použití \(\Gamma_*D_\psi\), jeho normalizace, levé/pravé působení a původ na úrovni akce | OPEN (NARROWED: plochý Hamiltonián klidových módů a konečné normální uspořádání nedává výběr; viz `psi_fock_quantization_chirality_link.cs.md`) |
