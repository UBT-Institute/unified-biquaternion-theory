...
| G3-DYN | Dynamické použití \(\Gamma_*D_\psi\), jeho normalizace, levé/pravé působení a původ na úrovni akce | OPEN (NARROWED: uvedené chirálně diagonální interakce zachovávají konjugovanost vinutí; viz `chiral_current_interaction_audit.cs.md` a `psi_fock_quantization_chirality_link.cs.md`) |
